package OOD.Management.ParkingLot.Material;
 ...
 *
 * lintCode 498:
 * https://www.lintcode.com/problem/parking-lot/description
 */
...
public class ParkingLotLink {
    ...
    public ParkingLotLink(int n, int num_rows, int spots_per_row) {
        // Write your code here
        NUM_LEVELS = n;
